...
export module MaaUtils_LoggerUtils;

MAA_LOG_NS_BEGIN

#ifdef __GNUC__
export inline std::ostream& operator<<(std::ostream& os, const std::chrono::milliseconds& ms)
{
...
export struct MAA_UTILS_API separator
{
...
export class MAA_UTILS_API StringConverter
{
public:
...
export class MAA_UTILS_API LogStream
{
public:
